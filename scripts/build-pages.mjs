...
<link rel="stylesheet" href="/assets/v8-base.css?v=10.0">
<link rel="stylesheet" href="/assets/v8-responsive.css?v=10.0">
<link rel="stylesheet" href="/assets/local-icons.css?v=10.0">
<link rel="stylesheet" href="/assets/product-improvements.css?v=10.0">
<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebApplication","name":"맞팔체커","url":"https://unfollow.lavalabs.co.kr/","applicationCategory":"UtilityApplication","operatingSystem":"Any","isAccessibleForFree":true,"description":"Instagram 데이터 ZIP을 브라우저에서만 분석해 맞팔과 취소 검토 계정을 확인하는 로컬 분석 도구","creator":{"@type":"Organization","name":"Lava Labs","url":"https://lavalabs.co.kr/"}}</script>`;
